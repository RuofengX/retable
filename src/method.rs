...
///
pub type MergeFn = dyn FnMut(EID, Option<Value>, Delta) -> Option<Value> + Send + Sync;
...
///
pub type TickFn = dyn FnMut(&EID, Value, &dyn crate::api::PropStorage) -> Option<Delta> + Send + Sync;
